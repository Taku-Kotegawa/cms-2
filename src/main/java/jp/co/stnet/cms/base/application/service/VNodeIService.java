 ...
 * @param <V> Viewエンティティのクラス(Tと同じでも構わない)
 * @param <E> Exampleクラス
 * @param <I> 主キーのクラス
 */
public interface VNodeIService<T, V, E, I> {
     ...
     * DataTables用の検索
     */
    Page<V> findPageByInput(DataTablesInput input);

    /**
     * Example + RowBounds による検索(
     */
    Page<V> findPageByExampleWithRowBounds(E example, RowBounds rowBounds);
