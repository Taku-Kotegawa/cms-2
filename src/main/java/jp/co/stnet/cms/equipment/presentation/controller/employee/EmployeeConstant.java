...
public class EmployeeConstant {
    ...
    // Viewファイル(.html)のパス
    static final String BASE_PATH = "equipment/employee";
    ...
    // CSV/TSVのファイル名(拡張子除く)
    static final String DOWNLOAD_FILENAME = "equipment-employee";

    // アップロード用のインポートジョブID
    static final String UPLOAD_JOB_ID = "uploadEquipmentEmployee";
