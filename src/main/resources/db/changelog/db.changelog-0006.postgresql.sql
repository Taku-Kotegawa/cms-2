...
CREATE TABLE "confirm_history" ("confirm_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "check_status" VARCHAR(255) NOT NULL, "execute_date" date NOT NULL, "equip_id" BIGINT, "execute_by" VARCHAR(255), CONSTRAINT "confirm_history_pkey" PRIMARY KEY ("confirm_id"));
...
CREATE TABLE "equip_type" ("equip_type_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "equip_type" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "equip_type_pkey" PRIMARY KEY ("equip_type_id"));
...
CREATE TABLE "manage_equip" ("equip_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "equip_name" VARCHAR(255) NOT NULL, "note" TEXT, "purchase_date" date NOT NULL, "request_id" BIGINT, "equip_type_id" BIGINT, "owner_id" VARCHAR(255), CONSTRAINT "manage_equip_pkey" PRIMARY KEY ("equip_id"));
...
CREATE TABLE "organization" ("organization_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "director_id" BIGINT, "group_name" VARCHAR(255) NOT NULL, "parent_id" BIGINT, "status" VARCHAR(255) NOT NULL, CONSTRAINT "organization_pkey" PRIMARY KEY ("organization_id"));
...
CREATE TABLE "position" ("position_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "position_name" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "position_pkey" PRIMARY KEY ("position_id"));
...
CREATE TABLE "request_equip" ("request_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "equip_name" VARCHAR(255), "note" VARCHAR(255), "progress_state" SMALLINT, "reason" VARCHAR(255), "request_date" date, "approval_flow_id" BIGINT, "equip_type_id" BIGINT, "requester_id" VARCHAR(255), CONSTRAINT "request_equip_pkey" PRIMARY KEY ("request_id"));
...
CREATE TABLE "employee" ("emp_id" VARCHAR(255) NOT NULL, "created_by" VARCHAR(255) NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "email" VARCHAR(255), "emp_name" VARCHAR(255) NOT NULL, "password" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, "organization_id" BIGINT, "position_id" BIGINT, CONSTRAINT "employee_pkey" PRIMARY KEY ("emp_id"));
