...
ALTER TABLE account_roles ADD CONSTRAINT fksa8fblleof2c8aqce4x3n0yy5 FOREIGN KEY (account_username) REFERENCES accountAndRoles (username) ON UPDATE NO ACTION ON DELETE NO ACTION;
